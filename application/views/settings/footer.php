...
<script
	src="<?= base_url() ?>assets/node_modules/x-editable/dist/bootstrap3-editable/js/bootstrap-editable.min.js"></script>
...
<script type="text/javascript"
		src="<?= base_url('assets/js/components/header.js?v=1.0.0&&load=' . time() . '') ?>"></script>
<script type="text/javascript"
		src="<?= base_url('assets/js/components/footer.js?v=1.0.0&&load=' . time() . '') ?>"></script>
<script type="text/javascript"
		src="<?= base_url('assets/js/components/service.js?v=1.0.0&&load=' . time() . '') ?>"></script>
